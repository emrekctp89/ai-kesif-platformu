  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Bir fikrin veya basit bir prompt'un var mı? AI Mentor'dan geri bildirim alarak onu
          mükemmelleştir.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <Button
          ...
          disabled={isPending || prompt.length < 10}
          className="w-full"
        >
          ...
          <div className="space-y-4 pt-6 border-t animate-in fade-in-50">
            ...
            <div>
              ...
              <div className="relative">
                <Textarea
                  value={feedback.improved_prompt}
                  readOnly
                ...
                <Button
                  ...
                  onClick={() => handleCopyToClipboard(feedback.improved_prompt)}
                >
