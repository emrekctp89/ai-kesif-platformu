...
export const WeeklyNewsletterEmail = ({ newsletterData }) => (
  ...
  >
    <div style={{ maxWidth: '600px', margin: 'auto', border: '1px solid #ddd' }}>
      {/* Header */}
      <div
        style={{
          backgroundColor: '#222',
      ...
      >
        <h1 style={{ fontSize: '28px', color: 'white', margin: 0 }}>AI Keşif Haftalık</h1>
      </div>

      <div style={{ padding: '24px' }}>
        {/* Giriş Yazısı */}
        <p style={descriptionStyle}>
          Merhaba! AI Keşif Platformu'nda bu hafta öne çıkanlar ve topluluğun en sevdikleri burada.
          İşte kaçırmamanız gerekenler:
        </p>
          ...
          <div style={{ ...sectionStyle, borderBottom: 'none' }}>
            ...
            >
              <div style={cardStyle}>
                ...
                <p style={descriptionStyle}>{newsletterData.latest_post.description}</p>
              </div>
            </a>
          </div>
        )}
