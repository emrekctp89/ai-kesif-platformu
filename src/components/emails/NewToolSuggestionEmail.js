...
export const NewToolSuggestionEmail = ({
  ...
  <div>
    ...
    <p>Merhaba Admin, AI Keşif Platformu'na yeni bir araç önerisi geldi.</p>
    <hr />
    <h2>Detaylar:</h2>
    <ul>
      <li>
        <strong>Araç Adı:</strong> {toolName}
      </li>
      <li>
        <strong>Web Sitesi:</strong> <a href={toolLink}>{toolLink}</a>
      </li>
      <li>
      ...
      <li>
        ...
        {isLoggedInUser ? '(Giriş yapmış kullanıcı)' : '(Misafir kullanıcı)'}
      </li>
    </ul>
    <hr />
    <p>Bu öneriyi incelemek ve onaylamak için lütfen admin panelini ziyaret edin.</p>
    <a
