...
export const GoodbyeEmail = ({ userEmail }) => (
  <div style={{ fontFamily: 'sans-serif', padding: '20px' }}>
    <h1 style={{ color: '#333' }}>Gidişinize Üzüldük...</h1>
    <p>Merhaba {userEmail},</p>
    <p>
      Hesabınızı sildiğinizi onaylamak için bu e-postayı gönderiyoruz. Platformumuza yaptığınız tüm
      katkılar için teşekkür ederiz.
    </p>
    <p>
