...
describe('EmptyState component', () => {
  ...
  it('renders error variant correctly', () => {
    render(
      <EmptyState title="An Error Occurred" description="Something went wrong" variant="error" />
    );
  ...
  it('renders action button when action property is provided', () => {
    ...
    render(
      <EmptyState title="No Results" action={{ label: 'Clear Filters', onClick: handleAction }} />
    );
