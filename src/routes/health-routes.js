 ...
 */
export const health = factory.createGetHandler(
  async (req, res, next) => {
 ...
 */
export const ready = factory.createGetHandler(
  async (req, res, next) => {
 ...
 */
export const status = factory.createGetHandler(
  async (req, res, next) => {
    const uptime = process.uptime();
    const memoryUsage = process.memoryUsage();
 ...
 * Version endpoint
 */
export const version = factory.createGetHandler(
  async (req, res, next) => {
 ...
 */
export const dependencies = factory.createGetHandler(
  async (req, res, next) => {
    const packageJson = require('../../package.json');
