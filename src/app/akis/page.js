...
import { Heart, MessageSquare, Star, Image as ImageIcon, Users, Rss } from 'lucide-react';
        ...
        {feedItems.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-muted-foreground mt-2">
              İlgi çekici bulduğunuz kullanıcıları takip etmeye başlayın. <br /> Onların
              aktiviteleri burada görünecektir.
            </p>
          </div>
        )}
      </div>
