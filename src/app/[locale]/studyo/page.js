...
export default async function StudioPage() {
  ...
  if (!user) {
    redirect(
      '/login?message=' + encodeURIComponent('AI Stüdyosunu kullanmak için giriş yapmalısınız.')
    );
  }
  ...
  if (!isProUser) {
    redirect(
      '/uyelik?message=' +
        encodeURIComponent('AI Stüdyosunu kullanmak için Pro üyeliğe yükseltmelisiniz.')
    );
  }
