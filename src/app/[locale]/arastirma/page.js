...
export const metadata = {
  ...
  description:
    'Yapay zeka alanındaki en son bilimsel makaleleri, araştırmaları ve öncü akademisyenleri keşfedin.',
};
    ...
    <div className="container mx-auto max-w-4xl py-12 px-4">
      <div className="text-center mb-12">
        ...
        <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground">
          Yapay zekanın bilimsel temellerini keşfedin. En son makaleler, araştırmalar ve daha
          fazlası.
        </p>
      </div>
      ...
      <div className="space-y-8">
        {papers.length > 0 ? (
          ...
          <p className="text-center text-muted-foreground py-16">
            Henüz yayınlanmış bir akademik makale bulunmuyor.
          </p>
        )}
      </div>
    </div>
