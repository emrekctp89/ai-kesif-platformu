...
serve(async (req)=>{
  ...
  try {
    ...
    const { data: analyticsData, error: analyticsError } = await supabaseAdmin.rpc("get_full_platform_analytics");
      ...
      generationConfig: {
        ...
        responseSchema: {
          ...
          properties: {
            ...
            action_suggestion: {
              type: "STRING",
              description: "Tüm bu analizlere dayanarak, adminin bu hafta odaklanması gereken EN ÖNEMLİ tek bir aksiyon önerisi sun."
            }
          },
          required: [
            "briefing_title",
